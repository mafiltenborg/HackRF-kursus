...
# Title: Radio
# Author: Martin Filtenborg
# Description: THe classic 'Hello world' for SDR
...
class Lesson1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, center_freq=95.9e6, channel_width=200e3):
        ...
        # Variables
        ##################################################
        self.volume_slider = volume_slider = 0.5
        self.samp_rate = samp_rate = 10e6
        self.channel_freq = channel_freq = 95.9e6

        ##################################################
        # Blocks
        ##################################################

        self._volume_slider_range = qtgui.Range(0, 2, 0.1, 0.5, 200)
        self._volume_slider_win = qtgui.RangeWidget(self._volume_slider_range, self.set_volume_slider, "'volume_slider'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._volume_slider_win)
        self._channel_freq_range = qtgui.Range(88.0e6, 108e6, 1e5, 95.9e6, 200)
